...
class User extends Component{
  ...
  getStatus(){
    ...
    if (user.Tasks[0].UserTask.shareStatus == "pending"){                                                //if the share is in pending status
      return (
    ...
    if (user.Tasks[0].UserTask.shareStatus == "accepted"){                                                   //if the share was accepted
      return (
        <span className={css.status}>
    ...
    if (user.Tasks[0].UserTask.shareStatus == "declined"){                                                        //if the share was declined
      return (
